...
from diagnosis_code.models import DiagnosisCode, Category
...
base_url_detail = 'diagnosis-detail'
...
class TestViewListCreate(APITestCase):
    ...
    def test_diagnosisCode_create_no_data_POST(self):
        req_body = {} 
        response = self.client.post(reverse(base_url), req_body)
...
class TestRetrieveUpdateDelete(APITestCase):
    ...
    def test_diagnosisCode_retrieve_GET(self):
        response = self.client.get(reverse(base_url_detail, args=[self.diagnosisCode.id]))
    ...
    def test_diagnosisCode_update_PATCH(self):
        ...
        response = self.client.patch(reverse(base_url_detail, args=[self.diagnosisCode.id]), req_body)
    ...
    def test_diagnosisCode_update_PUT(self):
        ...
        response = self.client.put(reverse(base_url_detail, args=[self.diagnosisCode.id]), req_body)
    ...
    def test_diagnosisCode_delete_DELETE(self):
        response = self.client.delete(reverse(base_url_detail, args=[self.diagnosisCode.id]))
